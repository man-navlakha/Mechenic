...
const JobNotificationPopup = ({ job, onAccept, onReject }) => {
  ...
  return (
    <>
      <div className='fixed inset-0 z-[2000] flex items-end justify-center bg-black/60 backdrop-blur-sm pointer-events-none'>
        <div className="relative z-[2001] pointer-events-auto">
